...
const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Krishneshwaran.</span> I'm a{" "}
        <span className="font-bold">Python developer</span>. I enjoy building{" "}
        <span className="italic">sites & apps</span>. My focus is{" "}
        <span className="underline">Python (AI)</span>.
      </motion.h1>
      <motion.div
      ...
      >
        ...
        <a
          ...
          href="https://github.com/Krishneshwaran"
          target="_blank"
        >
          <BsGithub />
        </a>
